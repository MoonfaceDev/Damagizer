...
PIGMAN_SWORD = SwordType(rarity=Rarity.LEGENDARY, damage=200, stats=Stats(strength=100, crit_damage=30, intelligence=300, crit_chance=5))
...
MIDAS_SWORD = SwordType(rarity=Rarity.LEGENDARY, damage=150, stats=Stats(), gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.JASPER})
...
DAEDALUS_AXE = SwordType(rarity=Rarity.LEGENDARY, damage=0, stats=Stats(), gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.COMBAT})
...
VORPAL_KATANA = SwordType(rarity=Rarity.EPIC, damage=155, stats=Stats(strength=80, crit_damage=25, intelligence=200),
                          gemstone_slots={GemstoneSlot.JASPER, GemstoneSlot.SAPPHIRE})
ATOMSPLIT_KATANA = SwordType(rarity=Rarity.LEGENDARY, damage=245, stats=Stats(strength=100, crit_damage=30, intelligence=300),
...
BURSTMAW_DAGGER = SwordType(rarity=Rarity.EPIC, damage=130, stats=Stats(strength=55, crit_damage=20, attack_speed=10),
                               gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.OPAL})
HEARTFIRE_DAGGER = SwordType(rarity=Rarity.LEGENDARY, damage=160, stats=Stats(strength=75, crit_damage=25, crit_chance=10, attack_speed=20),
                               gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.OPAL})
HEARTMAW_DAGGER = SwordType(rarity=Rarity.LEGENDARY, damage=160, stats=Stats(strength=75, crit_damage=25, crit_chance=10, attack_speed=20),
                               gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.OPAL})
...
SHADOW_FURY = SwordType(rarity=Rarity.LEGENDARY, damage=300, stats=Stats(strength=125, speed=30),
                        gemstone_slots={GemstoneSlot.JASPER})
LIVID_DAGGER = SwordType(rarity=Rarity.LEGENDARY, damage=210, stats=Stats(strength=60, crit_chance=100, crit_damage=50, attack_speed=100),
                         gemstone_slots={GemstoneSlot.JASPER})
GIANTS_SWORD = SwordType(rarity=Rarity.LEGENDARY, damage=500, stats=Stats(), gemstone_slots={GemstoneSlot.JASPER, GemstoneSlot.JASPER})
...
SCYLLA = SwordType(rarity=Rarity.LEGENDARY, damage=270, stats=Stats(strength=150, intelligence=50, ferocity=30, crit_chance=12, crit_damage=35),
                   gemstone_slots={GemstoneSlot.COMBAT, GemstoneSlot.COMBAT})
ASTRAEA = SwordType(rarity=Rarity.LEGENDARY, damage=270, stats=Stats(strength=150, intelligence=50, ferocity=30, true_defense=20, defense=250),
